...
class HistoryAdmin(BaseOwnerAdmin):
    ...
    fieldsets=(("分析人信息",{"description":"这里显示的是分析人的相关信息","fields":("person",)}),
                ("数据相关信息",{"description":"这里显示的是分析结果相关的信息","fields":(("folder","path"))}),
                ("项目相关信息",{"description":"这里显示的是项目相关的信息","fields":(("serialnum"),)})
                )
    ...
    def operator(self,obj):
        #return format_html('<a href="{}">编辑</a>',reverse("admin:",args=(0bj,id)))
        return format_html('<a href="{}">编辑</a>',reverse("cus_admin:History",args=(obj.id)))
