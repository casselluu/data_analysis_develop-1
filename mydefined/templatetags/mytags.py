...
class CDR_split(template.Node):
	...
	def render(self,context):
		...
		#增加换行符修改每一个CDR的显示颜色
		final_str_light="<span class='cdr1'>%s&nbsp;</span><span class='cdr2'>%s&nbsp;</span><span class='cdr3'>%s&nbsp;</span>"%(cdr_list[0],cdr_list[1],cdr_list[2])
		final_str_heavy="<span class='cdr4'>%s&nbsp;</span><span class='cdr5'>%s&nbsp;</span><span class='cdr6'>%s&nbsp;</span>"%(cdr_list[3],cdr_list[4],cdr_list[5])
